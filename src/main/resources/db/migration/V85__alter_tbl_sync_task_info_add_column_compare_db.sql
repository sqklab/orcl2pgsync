ALTER TABLE "tbl_db_comparison_info" ADD source_compare_database varchar(50);
ALTER TABLE "tbl_db_comparison_info" ADD target_compare_database varchar(50);
...
create view view_comparison_info
            (synchronizer_name, source_database, source_schema, source_table, target_database, target_schema,
             target_table, rd_source_database, rd_source_schema, rd_target_database, rd_target_schema, id, is_comparable, sync_id, sync_rd_id,
             source_compare_database, target_compare_database, source_query, target_query)
as
...
create view view_comparison_result
            (synchronizer_name, topic_name, source_database, source_schema, source_table, target_database, target_schema,
             ...
             rd_target_table, id, sync_id, sync_rd_id, source_compare_database, target_compare_database, source_query, target_query, compare_result_id, compare_date,
